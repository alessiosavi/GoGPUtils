...
func TestReadFileInArray(t *testing.T) {}
func BenchmarkReadFileInArray(b *testing.B) {
	for i := 0; i < b.N; i++ {
	}
}
...
func BenchmarkCreateDir(b *testing.B) {
	for i := 0; i < b.N; i++ {
	}
}
func TestGetFileModification(t *testing.T) {}
func BenchmarkGetFileModification(b *testing.B) {
	for i := 0; i < b.N; i++ {
	}
}
func TestGetFileDate(t *testing.T) {}
func BenchmarkGetFileDate(b *testing.B) {
	for i := 0; i < b.N; i++ {
	}
}
...
func TestVerifyFilesExists(t *testing.T) {}
func BenchmarkVerifyFilesExists(b *testing.B) {
	for i := 0; i < b.N; i++ {
	}
}
...
func BenchmarkGetFileContentType(b *testing.B) {
	for i := 0; i < b.N; i++ {
	}
}
...
func BenchmarkGetFileSize2(b *testing.B) {
	for i := 0; i < b.N; i++ {
	}
}
func TestFilterFromFile(t *testing.T) {}
func BenchmarkFilterFromFile(b *testing.B) {
	for i := 0; i < b.N; i++ {
	}
}
func TestFilterNotMatch(t *testing.T) {}
func BenchmarkFilterNotMatch(b *testing.B) {
	for i := 0; i < b.N; i++ {
	}
}
